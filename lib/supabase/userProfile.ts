...
export const CLIENT_COLUMNS_BASE =
  "id, user_id, advisor_user_id, status, display_name, email, phone, currency_code, onboarding_step, last_review_at, next_review_due, feedback_prompted_at, feedback_submitted_at, feedback_prompt_dismissed_at, date_of_birth, ethnicity, created_at, updated_at";
