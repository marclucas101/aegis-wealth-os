...
export default function AdvisorReportModal({
  title,
  subtitle,
  onClose,
  children,
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="advisor-report-modal-title"
    >
      <button
        type="button"
      ...
      <div className="relative flex max-h-[90vh] w-full max-w-3xl flex-col overflow-hidden rounded-sm border border-[#D1A866]/20 bg-[#10283A] shadow-2xl">
        ...
        <div className="flex items-start justify-between gap-4 border-b border-[#D1A866]/10 px-5 py-4 sm:px-6">
          <div className="min-w-0">
            ...
            <h2
              id="advisor-report-modal-title"
              className="mt-1 truncate text-base font-light tracking-wide text-[#F3F1EA] sm:text-lg"
            >
              {title}
            </h2>
            {subtitle ? (
