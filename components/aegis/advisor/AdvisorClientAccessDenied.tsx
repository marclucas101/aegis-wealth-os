...
export default function AdvisorClientAccessDenied() {
  return (
    <div className="relative overflow-hidden rounded-sm border border-[#D1A866]/20 bg-[#10283A]/50 p-8 sm:p-12">
      ...
      <div className="relative mx-auto max-w-lg text-center">
        ...
        <p className="mt-4 text-sm font-light leading-relaxed text-[#F3F1EA]/45">
          You do not have permission to view this client workspace. Advisors may
          only access clients assigned to their account.
        </p>
