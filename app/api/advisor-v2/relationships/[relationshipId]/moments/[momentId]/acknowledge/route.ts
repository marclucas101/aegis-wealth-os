...
import { acknowledgeRelationshipMoment } from "@/lib/crm-v2/moments/moments";
...
export async function POST(
  ...
  try {
    ...
    const result = await acknowledgeRelationshipMoment({
    ...
    return NextResponse.json(
      { ok: false, error: toPublicErrorMessage(err, "Failed to acknowledge moment") },
