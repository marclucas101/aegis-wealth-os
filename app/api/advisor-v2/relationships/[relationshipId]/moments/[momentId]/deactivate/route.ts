...
import { deactivateRelationshipMoment } from "@/lib/crm-v2/moments/moments";
...
export async function POST(
  ...
  try {
    ...
    const result = await deactivateRelationshipMoment({
    ...
    return NextResponse.json(
      { ok: false, error: toPublicErrorMessage(err, "Failed to deactivate moment") },
