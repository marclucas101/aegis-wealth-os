...
import { getAdviserProtectionExtraction } from "@/lib/crm-v2/protection/protection";
...
export async function GET(
  ...
  try {
    ...
    const result = await getAdviserProtectionExtraction({
    ...
    return NextResponse.json(
      { ok: false, error: toPublicErrorMessage(err, "Failed to load extraction") },
