...
import { updateCommunicationFollowUp } from "@/lib/crm-v2/communications/communications";
import type { CommunicationFollowUpInput } from "@/lib/crm-v2/communications/types";
...
export async function POST(
  ...
  try {
    ...
    const body = (await request.json()) as CommunicationFollowUpInput;
    ...
    return NextResponse.json(
      { ok: false, error: toPublicErrorMessage(err, "Failed to update follow-up") },
