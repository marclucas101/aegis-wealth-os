-- Shared authoritative resolved inventory for Phase 9F.2 migration 202606200009 diagnostics.
-- Included verbatim in verify and discrepancy SQL files between PHASE9F2_RESOLVED_CORE markers.
